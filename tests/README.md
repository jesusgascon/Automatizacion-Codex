...
- comparacion del backup contra la base actual antes de restaurar,
- vista agrupada por proyecto,
- agrupacion por raiz Git,
- exportacion del listado a Markdown y CSV,
- ayuda contextual en listado, acciones y herramientas,
- exportacion/importacion de configuracion local,
- auditoria de compatibilidad Codex CLI,
